            ...
            <div className="flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:space-x-5 items-start">
              ...
              <div className="w-full lg:max-w-126.25 p-5 md:px-6 flex-col space-y-4 md:space-y-6 rounded-[20px] border border-black/10">
                ...
                <div className="flex space-x-3">
                  ...
                  <Button
                    type="button"
                    className="bg-black text-white rounded-full w-full max-w-29.75 h-12"
                  >
                    Apply
                  </Button>
                </div>
                <Button
                  type="button"
                  className="text-sm md:text-base font-medium bg-black text-white rounded-full w-full py-4 h-13.5 md:h-15 group"
                  asChild
                >
                  <Link href="/checkout">
                    Go to Checkout{" "}
